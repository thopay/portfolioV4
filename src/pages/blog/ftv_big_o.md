...
---
The following is taken from my COM S 228 lecture notes (Fall 2021). These are included to give a basic idea of what Big-O is used for.
...
**Mathematical Definition**: If there exist positive constants $c$ and $n_{0}$ such that $∀n \geq n_{0}, f(n) \leq c*g(n)$ then $f ∈ O(g(n))$
